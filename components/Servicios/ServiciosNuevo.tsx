...
import { StickyScroll } from "@/components/StickyScrollServices/sticky-scroll-reveal";
...
export function ServiciosNuevo() {
  return (
    <div className="w-full py-4">
      <StickyScroll content={content} contentClassName={content} />
    </div>
  );
}
